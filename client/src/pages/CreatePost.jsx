...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => { 
    ...
    if (form.prompt && form.photo) {
      ...
      alert('Please entry a promt and generate an image')
    }
  ...
  return <section className="max-w-7xl mx-auto">
    <div>
      ...
      <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Create collection
        of imaginative and visually stunning images through DALL-E AI</p>
    </div>
    ...
    <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
      <div className="flex flex-col gap-5">
        ...
        focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
          ...
          {generatingImg && (<div className="absolute inset-0 z-0 flex 
